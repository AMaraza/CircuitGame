        ...
        if game_state == 0:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if game_menu.retry_button.collidepoint(event.pos):
                        game_grid.reset()
                        machine.reset()
                        game_time = 0
                        flash_red = False
                        ...
                        game_over_played = False
                        game_state = 3
                    elif game_menu.menu_button.collidepoint(event.pos):
                        game_grid.reset()
                        machine.reset()
                        game_time = 0
                        flash_red = False
